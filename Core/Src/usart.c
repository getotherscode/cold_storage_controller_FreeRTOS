...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, UART2_485_RIGHT_TX_Pin|UART2_485_RIGHT_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PC5     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOC, UART3_485_DISPLAY_TX_Pin|UART3_485_DISPLAY_RX_Pin);
  ...
  /* USER CODE END USART4_MspDeInit 0 */
    ...
    PC10     ------> USART4_TX
    */
    HAL_GPIO_DeInit(GPIOC, UART4_485_LEFT_RX_Pin|UART4_485_LEFT_TX_Pin);
